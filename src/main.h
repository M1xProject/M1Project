...
static const int NEW_MATURITY_HEIGHT = 3000;
static const int NEW_INTEREST_FORK = 5000;
...
static const double MAX_MONEY_REAL = 1000000;
...
static const uint256 hashGenesisBlock("0x00000f4f7948c893648b40ebe745482846685fa406a1daaca778f1887dec34b9");
...
public:
    ...
    {
        // M1: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // M1: get transaction coin age
...
public:
    ...
    // M1: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // M1: two types of block: proof-of-work or proof-of-stake
    ...
    // M1: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // M1: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // M1: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // M1: block index flags
    enum  
    {
